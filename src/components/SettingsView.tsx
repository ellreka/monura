...
function ShortcutCaptureButton({
    ...
    useEffect(() => {
        ...
        const handleKeyDown = (e: KeyboardEvent) => {
            ...
            if (requireModifier && !e.metaKey && !e.ctrlKey && !e.altKey)
                return;
            setRecording(false);
            onCommit(captured);
        };
    ...
    return (
        <div className="flex items-center gap-1">
            ...
            >
                {recording ? (
                    <span className="px-1 text-xs text-accent">
                        Press a key…
                    </span>
                ) : value ? (
...
export function SettingsView({
    ...
    return (
        <div className="h-full overflow-y-auto px-7 py-5">
            ...
            <div className="max-w-[560px] divide-y divide-border">
                    ...
                    <div className="py-3 first:pt-0 last:pb-0">
                        <div className="mb-2 flex flex-col gap-0.5">
                            ...
                            <div className="text-[11px] text-muted">
                                Up to {MAX_PRESETS} quick-start durations
                                (minutes) and their shortcuts.
                            </div>
                        </div>
                ...
                <Section title="Editor">
                    <Row
                        ...
                        description="Enable Vim-style editing in the editor."
                    >
                        <button
                            type="button"
                            role="switch"
            ...
            <div className="mt-4 max-w-[560px] text-[11px] text-muted">
